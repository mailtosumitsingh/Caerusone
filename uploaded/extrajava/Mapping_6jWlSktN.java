...
public class Mapping_6jWlSktN extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_6jWlSktN now");
...
Mapping_6jWlSktN testVar = new Mapping_6jWlSktN();
