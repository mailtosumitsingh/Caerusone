...
public class Mapping_lnEYzRyq extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_lnEYzRyq now");
...
Mapping_lnEYzRyq testVar = new Mapping_lnEYzRyq();
