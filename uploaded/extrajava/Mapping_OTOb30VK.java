...
public class Mapping_OTOb30VK extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_OTOb30VK now");
...
Mapping_OTOb30VK testVar = new Mapping_OTOb30VK();
