...
public class Mapping_H8KHLZu5 extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_H8KHLZu5 now");
...
Mapping_H8KHLZu5 testVar = new Mapping_H8KHLZu5();
