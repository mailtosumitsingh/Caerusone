...
public class Mapping_xyeRPZqr extends org.ptg.eventloop.AutomationHelper  {
public void run(java.util.Map<String,Object> ctx){
System.out.println("Going to execute \"run\" method in Mapping_xyeRPZqr now");
...
String msg = (String)("" + "lastly");
System.out.println(msg);
}
}

public static void main(String[] args){
Mapping_xyeRPZqr testVar = new Mapping_xyeRPZqr();
