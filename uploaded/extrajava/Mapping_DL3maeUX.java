...
public class Mapping_DL3maeUX extends org.ptg.eventloop.AutomationHelper  {
public void run(java.util.Map<String,Object> ctx){
System.out.println("Going to execute \"run\" method in Mapping_DL3maeUX now");
...
Mapping_DL3maeUX testVar = new Mapping_DL3maeUX();
