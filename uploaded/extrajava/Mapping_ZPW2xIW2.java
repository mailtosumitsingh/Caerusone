...
public class Mapping_ZPW2xIW2 extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_ZPW2xIW2 now");
...
Mapping_ZPW2xIW2 testVar = new Mapping_ZPW2xIW2();
