...
public class Mapping_xkaUvyV6 extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_xkaUvyV6 now");
...
var declarePortOut1 = testlocx.out.value;
var tempval = "Something";
findImageLoc(img);
ctx.set("testlocx.out.value",tempval);
}{/*Module1*/
}
}
}{/*sSendKey(JavaCode)*/
...
Mapping_xkaUvyV6 testVar = new Mapping_xkaUvyV6();
