...
public class Mapping_gRddEdkM extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_gRddEdkM now");
Map<String,org.sikuli.script.Region> regions = new HashMap<>();

{/*TestOutput1(JavaCode)*/
String in1 = (String)(""+100000);
String in2 = (String)(""+"value port 2");
int inint = (Integer)"300";
...
Mapping_gRddEdkM testVar = new Mapping_gRddEdkM();
