...
public class Mapping_2caREJ3j extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_2caREJ3j now");
...
int inint = (Integer)Integer.parseInt(""+300);
...
Mapping_2caREJ3j testVar = new Mapping_2caREJ3j();
