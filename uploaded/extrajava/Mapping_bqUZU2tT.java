...
public class Mapping_bqUZU2tT extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_bqUZU2tT now");
Map<String,org.sikuli.script.Region> regions = new HashMap<>();

{/*TestOutput1(JavaCode)*/
String in1 = (String)(""+"Some value");
...
Mapping_bqUZU2tT testVar = new Mapping_bqUZU2tT();
