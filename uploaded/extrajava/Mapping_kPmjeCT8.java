...
public class Mapping_kPmjeCT8 extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_kPmjeCT8 now");
...
Mapping_kPmjeCT8 testVar = new Mapping_kPmjeCT8();
