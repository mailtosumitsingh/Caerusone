...
public class Mapping_FspVzCsA extends org.ptg.eventloop.AutomationHelper implements Runnable {
public void run(){
		java.util.HashMap ctx = new java.util.HashMap();
System.out.println("Going to execute \"run\" method in Mapping_FspVzCsA now");
...
Mapping_FspVzCsA testVar = new Mapping_FspVzCsA();
