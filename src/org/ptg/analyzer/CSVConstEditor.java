...
import extra.ConstructorEditor;


public class CSVConstEditor extends ConstructorEditor {
    ...
    public void setCons(CtConstructor ctMethod, CtClass ctClass) {
        cMtd = ctMethod;
        cClass = ctClass;
    }
    ...
    public void editMethodCall(MethodCall methodCall) throws CannotCompileException {
        {
            if (checkDoubles(MatchTypes.classNameMatch, info.MatchType)) {
                if (methodCall.getClassName().equals(info.CalledClass)) {
