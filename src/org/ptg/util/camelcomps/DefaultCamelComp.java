...
public class DefaultCamelComp implements ICamelComp{
    ...
    public ICamelComp setInstId(String id){
    	this.uid = id;
    	return this;
    }
	...
	@Override
	public Object execute(AnonDefObj anon, List<FunctionPortObj> inputs, List<FunctionPortObj> output, FPGraph2 graph,Map<String, Object> executionCtx,Map<String, String> skipList ) {
		...
		executionCtx.put("from(\'"+this.name+"\')","");
		finished(anon.getId());
		}
		return "";
	}
